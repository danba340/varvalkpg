...
$(document).ready(function() {
    ...
    for(var i = 1; i <= numOfRunners; i++){
        parentDiv.append("<div id='button" + i + "' class='button btn-success' data-runner-no='" + i +"'>Nr: " + i +"<div class='lapcount'><span>Varv: </span>0</div><button class='add btn-default'><div>+</div></button><button class='remove btn-default'><div>-</div></button></div>");
    }
